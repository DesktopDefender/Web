    ...
    <main className="flex min-h-screen flex-col items-center p-12 bg-Dark2">
      ...
      <div className="mt-16 flex flex-col md:flex-row justify-between md:w-2/3">
        <Image
          ...
          width={280}
          height={280}
          className="mb-4 md:mb-0 rounded shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
        />
        <Image
          src={networkGraph}
          alt="Network Graph"
      ...
      <div className="w-2/3 pt-14">
        ...
        <p>
          Hey there! We're three friends from Reykjavik University on a mission
          from our 'Cyber Security: Defense Against the Dark Arts' class.
          Inspired by a challenge to lock down our networks, we created Desktop
          Defender. It's a simple tool to help you understand and protect your
          home network from those sneaky security threats. With Desktop
          Defender, managing your home network is a breeze!
        </p>
      </div>
      ...
      <div className="w-2/3 pt-14">
        ...
        <ul className="list-none pl-10">
          <li className="flex items-center mb-4">
            ...
            <p className="text-lg font-medium hover:text-DDOrange transition-colors duration-300">
